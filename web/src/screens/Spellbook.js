    ...
    const bosses = [
      ...
      },
      {
        ...
        attacks: [
          ...
          { name: 'Carrot Rain', desc: 'A staged carrot meteor barrage with shifting safe gaps' },
          ...
          { name: 'Golem Quake Notes', desc: 'Side golems shake note bursts horizontally through full rows' },
          { name: 'Note Burst Spiral', desc: 'Musical bursts spiral inward after the boss is hit' },
          { name: 'Bunny Stampede', desc: 'Bunnies hop through mirrored zig-zag lanes after the boss is hit' },
        ],
